...
public abstract class TaskDtoMapper {
    ...
    @Mapping(target = "assigneeId", expression = "java(getAssigneeId(source))")
    ...
    protected UUID getAssigneeId(TaskDto taskDto) {
        return taskDto.getAssignee() != null ? taskDto.getAssignee().getId() : null;
    }
